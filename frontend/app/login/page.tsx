      ...
      <div className="w-full max-w-sm">
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex justify-center">
            <button
              type="button"
              className="w-14 h-14 flex items-center justify-center rounded-full bg-white/30 border-2 border-white/10 hover:bg-white/30 hover:border-white/30 transition-colors"
            >
              <svg
                className="w-10 h-10"
                viewBox="0 0 24 24"
